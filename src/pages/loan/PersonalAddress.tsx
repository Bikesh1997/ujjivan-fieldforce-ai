  ...
  return (
    <div className="flex flex-col h-screen">
      <div className="flex-1 overflow-y-auto pt-20 pb-32">
        <div className="w-full max-w-md mx-auto px-6 py-8 space-y-8">
          <div className="space-y-3 text-center">
            <h1 className="text-3xl font-bold text-foreground tracking-tight">Personal & Residential Details</h1>
            <p className="text-muted-foreground text-base leading-relaxed">Please provide your personal and address information</p>
          </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 p-6 bg-background border-t border-border">
        <Button size="lg" onClick={handleContinue} className="w-full max-w-md mx-auto h-12 rounded-2xl block">
          Continue
        </Button>
      </div>
    </div>
